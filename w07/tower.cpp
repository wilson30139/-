...
int tower1(int n, char from, char aux, char to)
...
int tower2(int n, char to, char aux, char from)
...
int tower3(int n, char from, char to, char aux)
...
int tower4(int n, char to, char from, char aux)
...
int tower5(int n, char aux, char from, char to)
...
int tower6(int n, char aux, char to, char from)
